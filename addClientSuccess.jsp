...
<br>
	<body>
			<form align="center" action="addClientProcess.jsp">
				<table align="center" border="1">
					<tr>
						<td>PersonFirstName</td><td><input type="text" name="firstName"></td>
					</tr>
					<tr>
						<td>SecondName</td><td><input type="text" name="secondName"></td>
					</tr>
					<tr>
						<td>Phone</td><td><input type="text" name="phone"></td></td> 
					</tr>
					<tr>
						<td>Alt.Phone</td><td><input type="text" name="altPhone"></td></td>
					</tr>
					<tr>
						<td>Whatsapp</td><td><input type="text" name="whatsapp"></td></td>
					</tr>
					<tr>
						<td>Facebook</td><td><input type="text" name="facebook"></td></td>
					</tr>
					<tr>
						<td>Email</td><td><input type="text" name="email"></td></td>
					</tr>
				</table>
				<button  type="submit" value="Submit">Add</button>
				<p>Client Details Added Successfully with CustomerID----><%out.println(session.getAttribute("CustomerID1"));%></p>
			</form>
	</body>
</html>