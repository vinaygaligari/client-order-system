...
<br>
	...
	<body>
			<form align="center" action="addSubjectProcess.jsp">
				<table align="center" border="1">
					<tr>
						<td>Subject</td><td><input  name="subject"></td>
					</tr>
					<!--
					<tr>
						<td>SubjectType</td><td><input  name="subjectType"></td>
					</tr>
					-->
					<tr>
						<td>SubjectType</td>
					...
					<tr>
						<td>SubjectID</td><td><input  name="subjectId"></td>
					</tr>
				</table>
				<button  type="UniversityID" value="Submit">Submit</button>
				<p>Subject Details Added Successfully</p>
