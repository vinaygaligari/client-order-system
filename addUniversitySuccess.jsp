...
<br>
	...
	<body>
			<form align="center" action="addUniversityProcess.jsp">
				<table align="center" border="1">
					<tr>
						<td>University</td><td><input  name="university"></td>
					</tr>
					<tr>
						<td>Course</td><td><input name="course"></td>
					</tr>
					<tr>
						<td>Country</td><td><input  name="country"></td>
					</tr>
					<tr>
						<td>UniversityID</td><td><input  name="universityId"></td>
					</tr>
				</table>
				<button  type="UniversityID" value="Submit">Submit</button>
				<p>University Details Added Successfully</p>
