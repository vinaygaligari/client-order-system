...
try
{
	...
	ResultSet rs;
	rs=st.executeQuery("Select * from  addclient"); 
	%>
	<body>	
				<table align="center" border="1">
				<tr><th>CustomerID</th><th>FirstName</th><th>SecondName</th><th>Phone</th>
					<th>AltPhone</th><th>Whatsapp</th><th>Facebook</th><th>Email</th>			
				</tr>
	<%
	while(rs.next())
	{
...
%>
					...
					<tr>
						...
						<td><%out.println(SecondName);%></td>
						<td><%out.println(Phone);%></td>
						<td><%out.println(AltPhone);%></td>
						<td><%out.println(Whatsapp);%></td>
						<td><%out.println(Facebook);%></td>
