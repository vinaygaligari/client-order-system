...
<br>
	<body>
				...
				<tr><th>CustomerID</th><th>PaymentDue</th></tr>	
...
<%	
   try
   {
		...
		ResultSet rs = st.executeQuery("SELECT * FROM payment Where TaskEndDate>=curdate() and Status='"+"open"+"' Order by CustomerID Asc");
		int x=0; 
		int y=0; 
		int z=0; 
		int min=100000;
		...
		int finalDue=0; 
			...
			{	
				...
				if(due>0)
				{
					...
					//out.println("success");
				%>
				<tr><td><%out.println(CustomerID1);%></td><td><%out.println(due);%></tr>		
				<%
				}
			} 
	...
	%>
				...
				<tr><td></td><th>Total PaymentDue</th></tr>
				<tr><td></td><td><%out.println(finalDue);%></td></tr>	
...
<p align="center"><a href="paymentSearch.jsp">See TotalPaymentDue for Each customer???... Click Here</a></p>
	</body>
</html>	