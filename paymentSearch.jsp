...
<br>
	...
	<body>
				<table align="center" border="1">
					<tr>
						<td>CustomerID</td>
						<td><select name="customerId" id="cid" onchange="myFunction()">
...
%>							
						...
						function myFunction(){
							...
							window.location.replace("paymentSearch.jsp?customerId="+x)					
						}
						</script>
...
<%	
      ...
      <p align="center"><%out.println("Please select ***CustomerID*** from the list to make payment");%></p>      
<% }   
%>
